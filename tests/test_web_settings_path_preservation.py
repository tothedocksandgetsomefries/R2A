...
def test_save_stage_model_defaults_preserves_user_path(tmp_path: Path, monkeypatch) -> None:
    ...
    user_config_path = "/home/x/.openclaw/openclaw.json"
    unc_read_path = "\\\\wsl.localhost\\Ubuntu\\home\\x\\.openclaw\\openclaw.json"
